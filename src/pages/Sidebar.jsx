...
const Sidebar = () => {
    ...
    <div className="logo med my-4 d-flex align-items-center justify-content-around">
        <i className="bi bi-clipboard2-check fs-1 text-white mx-2"></i>
        <h4 className="text-white fw-bold mx-2 d-none d-sm-block">My-Task</h4>
    </div>
            ...
            {menuItems.map((item, index) => {
                ...
                return (
                    <li className="nav-item mb-2" key={index}>
                        ...
                        <div className="collapse ps-4" id={collapseId}>
                            <ul className="list-unstyled">
                                {item.submenu.map((subItem, i) => (
                                    <li key={i} className="text-white py-1">
                                        <NavLink 
                                            to={subItem.navlink} 
